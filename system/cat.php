        ...
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li class="breadcrumbs__item breadcrumbs__item--current">
                    <a href="<?php echo $su."?get=cat&p=".$pq['id']; ?>" class="breadcrumbs__url"><?php echo $pq['cname']; ?></a>
                </li>
            </ul>
        </div>
                                    ...
                                    <div class="entry__header">
                                        ...
                                        <ul class="entry__meta">
                                            <li class="entry__meta-author">
                                                <span>نویسنده:</span>
                                                <?php $aquery=mysqli_query($conn,"SELECT * FROM `admin` Where `id`=".$cq['4']);$aq=mysqli_fetch_array($aquery); ?>
